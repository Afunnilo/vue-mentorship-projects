...
.tabItem > button > div:nth-child(5) {
  padding-right: 0px;
}
.tabItem > button > div > i:hover {
  color: #ffc059;
}
.tabItem > button > div:hover {
